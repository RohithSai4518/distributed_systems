/**
 * SQL Query Execution & AST Plan Visualizer Canvas Component
...
class SQLWorkbenchController {
    ...
    init() {
        console.log("SQLWorkbenchController initialized successfully.");
    }
...
if (typeof window !== "undefined") { window.SQLWorkbenchController = SQLWorkbenchController; }
